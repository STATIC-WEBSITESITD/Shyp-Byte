            ...
            <div className='col-lg-10'>
              <div className='tw-prose tw-prose-lg tw-max-w-none'>
                ...
                <p className='tw-text-body tw-leading-relaxed tw-mb-4'>
                  Terms &amp; Conditions of use of the Shyp Byte website
                </p>
                <p className='tw-text-body tw-leading-relaxed tw-mb-5'>
                  The following terms and conditions govern the use of the website www.shypbyte.com
                  (&quot;Shyp Byte website&quot;) of Shyp Byte, including all sections and services available on the
                  Shyp Byte website. The viewing or use of this site will constitute your agreement,
                ...
                <p className='tw-text-body tw-leading-relaxed tw-mb-5'>
                  Shyp Byte may make future changes or modifications to such terms and conditions at
                  any time without notice, and any subsequent viewing or use of the Shyp Byte website
                ...
                <p className='tw-text-body tw-leading-relaxed tw-mb-2'>
                  ...
                  services, and links on the Shyp Byte website.
                </p>
                <p className='tw-text-body tw-leading-relaxed tw-mb-4'>
                  &quot;Shyp Byte&quot; means Shyp Byte having its registered office
                ...
                <h3 className='h5 fw-semibold tw-mt-5 tw-mb-3'>Use of the Shyp Byte website</h3>
                <p className='tw-text-body tw-leading-relaxed tw-mb-5'>
                  The Shyp Byte website is provided solely for the use of current and potential
                  Shyp Byte customers to interact with Shyp Byte and may not be used by any other
                  person or entity, or for any other purpose.
                </p>

                <h3 className='h5 fw-semibold tw-mt-5 tw-mb-3'>Disclaimer of Warranty</h3>
                <p className='tw-text-body tw-leading-relaxed tw-mb-5'>
                  Use of the Shyp Byte website and its Content is at your sole risk. The Shyp Byte
                  ...
                  theory of law for any errors in or the use of or inability to use the Shyp Byte
                ...
                <p className='tw-text-body tw-leading-relaxed tw-mb-5'>
                  ...
                  in no event shall Shyp Byte&apos;s total liability for any damages (direct or
                ...
                <p className='tw-text-body tw-leading-relaxed tw-mb-5'>
                  You agree to defend, indemnify and hold harmless Shyp Byte and its affiliate
                ...
                <h3 className='h5 fw-semibold tw-mt-5 tw-mb-3'>Shyp Byte Conditions of Carriage</h3>
                <p className='tw-text-body tw-leading-relaxed tw-mb-5'>
                  The terms and conditions for using the Shyp Byte website and related services are
                  contained in the most current version of the Shyp Byte Conditions of Carriage, which
                  is available on request. The most current version of the Shyp Byte Conditions of
                  Carriage will be applicable in the event of any conflict between any Shyp Byte
                  services or related service information on the Shyp Byte website.
                </p>

                <h3 className='h5 fw-semibold tw-mt-5 tw-mb-3'>Links to other web sites</h3>
                <p className='tw-text-body tw-leading-relaxed tw-mb-5'>
                  There are links on the Shyp Byte website that allows you to visit the sites of third
                  parties. Neither these sites nor the companies to whom they belong are controlled
                  by Shyp Byte. Shyp Byte makes no representations concerning the information provided
                ...
                <p className='tw-text-body tw-leading-relaxed tw-mb-5'>
                  Shyp Byte has not tested and makes no representations regarding the correctness,
                ...
                <p className='tw-text-body tw-leading-relaxed tw-mb-5'>
                  This Agreement and your use of the Shyp Byte website is governed by and construed in
                ...
                <p className='tw-text-body tw-leading-relaxed'>
                  Any action with respect to the Shyp Byte website or this Agreement must be
